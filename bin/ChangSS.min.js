var parser = function () {
  ...
  var n = function (a, b, c, d) {
    ...
    return c
  }, o = [1, 11], p = [1, 10], q = [1, 8], r = [1, 4, 32, 40, 46], s = [1, 15], t = [1, 4, 24, 32, 40, 46], u = [1, 20], v = [1, 18], w = [14, 35, 42], x = [1, 4, 6, 8, 10, 11, 12, 13, 14, 15, 16, 19, 20, 22, 24, 27, 29, 31, 32, 35, 36, 37, 40, 46], y = [1, 4, 24, 27, 29, 31, 32, 36, 37, 40, 46], z = [1, 35], A = [1, 29], B = [1, 32], C = [1, 33], D = [1, 46], E = [1, 47], F = [1, 50], G = [1, 51], H = [1, 52], I = [1, 44], J = [1, 45], K = [27, 29, 31, 32, 36, 37], L = [1, 56], M = [24, 27, 29, 31, 32, 36, 37], N = [24, 27, 29, 31, 32, 35, 36, 37], O = [15, 24], P = [1, 4, 6, 8, 11, 14, 15, 16, 19, 20, 24, 27, 29, 31, 32, 36, 37, 40, 46], Q = [1, 66], R = [1, 67], S = [1, 68], T = [1, 69], U = [1, 4, 6, 8, 10, 11, 12, 13, 14, 15, 16, 19, 20, 24, 27, 29, 31, 32, 36, 37, 40, 46], V = [1, 4, 6, 8, 10, 11, 14, 15, 16, 19, 20, 24, 27, 29, 31, 32, 36, 37, 40, 46], W = {trace: function () {
  }, yy: {}, symbols_: {error: 2, "var": 3, VAR: 4, "->": 5, LITERAL: 6, exp: 7, NUMBER: 8, inlineFunc: 9, "+": 10, "-": 11, "*": 12, "/": 13, "(": 14, ")": 15, FUNCNAME: 16, list: 17, property: 18, STRING: 19, URL: 20, assignPair: 21, ":": 22, assignList: 23, ";": 24, defParamList: 25, includeCall: 26, INCLUDE: 27, scopeBodyPart: 28, IDENT: 29, nestedStyle: 30, EXTENDS: 31, SELECTOR: 32, scopeBody: 33, scope: 34, "{": 35, "}": 36, "&": 37, style: 38, mixScope: 39, MIXIN: 40, selectors: 41, ",": 42, sheetPart: 43, sheet: 44, SHEET: 45, EOF: 46, $accept: 0, $end: 1}, terminals_: {2: "error", 4: "VAR", 5: "->", 6: "LITERAL", 8: "NUMBER", 10: "+", 11: "-", 12: "*", 13: "/", 14: "(", 15: ")", 16: "FUNCNAME", 19: "STRING", 20: "URL", 22: ":", 24: ";", 27: "INCLUDE", 29: "IDENT", 31: "EXTENDS", 32: "SELECTOR", 35: "{", 36: "}", 37: "&", 40: "MIXIN", 42: ",", 45: "SHEET", 46: "EOF"}, productions_: [0, [3, 3], [3, 1], [7, 1], [7, 1], [7, 1], [7, 3], [7, 3], [7, 3], [7, 3], [7, 2], [7, 3], [9, 3], [9, 4], [18, 1], [18, 1], [18, 1], [18, 1], [17, 1], [17, 2], [21, 3], [23, 1], [23, 3], [23, 2], [25, 2], [25, 3], [26, 3], [26, 2], [28, 3], [28, 1], [28, 1], [28, 2], [28, 4], [28, 2], [33, 1], [33, 2], [34, 3], [34, 4], [34, 3], [34, 2], [30, 2], [30, 1], [39, 3], [41, 1], [41, 3], [38, 2], [43, 1], [43, 1], [43, 1], [43, 2], [44, 3], [44, 1], [44, 2], [44, 2]], performAction: function (a, b, c, l, m, n) {
    var o = n.length - 1;
    switch (m) {
      case 1:
    ...
    n(O, [2, 21]),
    n(t, [2, 42]),
    n([1, 15, 24, 32, 40, 46], [2, 20], {7: 43, 3: 48, 9: 49, 18: 65, 4: o, 6: D, 8: E, 11: F, 14: G, 16: H, 19: I, 20: J}),
    n(P, [2, 18]),
    ...
    n(M, [2, 32]),
    n(U, [2, 13])
  ], defaultActions: {}, parseError: function (a, b) {
    ...
    for (var t, u, v, w, x, y, z, A, B, C = {}; ;) {
      if (v = d[d.length - 1], this.defaultActions[v] ? w = this.defaultActions[v] : ((null === t || "undefined" == typeof t) && (t = b()), w = g[v] && g[v][t]), "undefined" == typeof w || !w.length || !w[0]) {
        ...
        D = o.showPosition ? "Parse error on line " + (i + 1) + ":\n" + o.showPosition() + "\nExpecting " + B.join(", ") + ", got '" + (this.terminals_[t] || t) + "'" : "Parse error on line " + (i + 1) + ": Unexpected " + (t == m ? "end of input" : "'" + (this.terminals_[t] || t) + "'"), this.parseError(D, {text: o.match, token: this.terminals_[t] || t, line: o.yylineno, loc: r, expected: B})
      }
  ...
  ChangeSS = function (a) {
    ...
    var g, i, j = {};
    return b.error = {notExist: function (a) {
    ...
    return a.errorHandler = {expect: function (a, b, c, d) {
      var e = a.lexer;
      return e.upcomingInput() == b ? c : (d && Error("expect:" + b + "after" + a.matched), !1)
    }}
  }(W), ChangeSS.TYPE = {NONE: "no", EXP: "exp", VAR: "var", LENGTH: "len", FUNC: "fun", KEYWORD: "keyword", LIST: "list"}, d.parse = function (a, b) {
    ...
    return c ? c[0] : 0 / 0
  }, d.fractionalDigitals = 4, d.convertTable = {rad: {pi: function (a) {
    return a / Math.PI
  }, deg: function (a) {
    ...
    return 180 * a
  }}}, d.prototype = {_type: ChangeSS.TYPE.LENGTH, clone: function () {
    ...
    return e.isVar = b, {_type: ChangeSS.TYPE.VAR, toString: function () {
    ...
    var a = ChangeSS.TYPE;
    return{_type: a.EXP, opt: function (a, b) {
      var c = this.left;
    ...
    return{arg: {sin: a[0], cos: a[0], tan: a[0]}, res: {asin: a[1], acos: a[1], atan: a[1], sin: a[2], cos: a[2], tan: a[2]}}
  }()), g.prototype = {_type: ChangeSS.TYPE.FUNC, getVarNames: function (a) {
    ...
    }}), Object.defineProperty(a, "resolved", {get: function () {
      return this.every(function (a) {
        return a instanceof d || "string" == typeof a
      })
    }}), Object.defineProperty(a, "hasVars", {get: function () {
  ...
  }(i), i.prototype = {selectors: [""], toString: function () {
    function a(a) {
      return a = a || window ? "\r\n" : "", function (c) {
    ...
    var l = !1;
    return Object.defineProperty(ChangeSS.opt, "keepEmptyResult", {set: function (a) {
      l = !!a
    }, get: function () {
      return l
    }}), function (a) {
    ...
    var c, d = a.clone;
    return c = Object.create(a), Object.defineProperty(c, "selector", {get: function () {
    ...
    }}), Object.defineProperty(c, "value", {get: function () {
  ...
  var X = function () {
    var b = {EOF: 1, parseError: function (a, b) {
    ...
    }, options: {}, performAction: function (b, c, d, e) {
      switch (d) {
        case 0:
          break;
        case 1:
